...
class DogCardAdapter(
    ...
    private val myDataSet = DataSource
    ...
    class DogCardViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        ...
        val textViewDogHobby: TextView = view!!.findViewById(R.id.dog_hobby)
    }
    ...
    override fun getItemCount(): Int {return dogs.size} // TODO: return the size of the data set instead of 0
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textViewDogAge.text = resources?.getString(R.string.dog_age, dog.age)
        // TODO: Set the text for the current dog's hobbies by passing the hobbies to the
        //  R.string.dog_hobbies string constant.
        //  Passing an argument to the string resource looks like:
        //  resources?.getString(R.string.dog_hobbies, dog.hobbies)
        holder.textViewDogHobby.text = resources?.getString(R.string.dog_hobbies,dog.hobbies)
    }
}
